...
##                pass
    ...
    def run_analysis(self):
        ...
        try:
            ...
            if self.modified_raw != "":
                self.raw_file = self.modified_raw
            else:
                self.raw_file = self.original_raw
            subprocess.Popen(
                [
                    "python",
...
# =======================================
    ...
    def show_line_loss(self):            
        ...
        json_file = os.path.splitext(self.raw_file)[0] + "_line_loss.json"
    ...
    def remove_line(self):
        ...
        modified_file = os.path.splitext(self.original_raw)[0] + "_modified.raw"

        with open(self.original_raw, "r", encoding="utf-8", errors="ignore") as f:
            lines = f.readlines()
        ...
        self.modified_raw = modified_file

        self.raw_file = modified_file

        messagebox.showinfo(

            "Success",

            f"Modified RAW created:\n{os.path.basename(modified_file)}"
        )
    ...
    def restore_network(self):
        ...
        self.file_label.config(
            text=os.path.basename(self.original_raw),
            fg="green"
        )

        messagebox.showinfo(
            "Restore",
            "Original RAW file restored successfully."
        )
